 ...
 */
export declare type ConnectionFilter<conParaT> = (connection: WSConnection<conParaT>, req: IncomingMessage) => Promise<void> | void | false | Promise<StatusError> | StatusError | true;
 ...
 */
export declare type EventDistibutionFilter<conParaT> = (allow: () => void, direction: "send" | "recive", connection: WSConnection<conParaT>, eventName: string, ...eventArgs: JSONTypes[]) => void;
export declare type WSEventMessage = WSEventMessageEvent | WSEventMessageError;
