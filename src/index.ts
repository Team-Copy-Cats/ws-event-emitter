...
import {WSHandler, StatusError} from "./WSHandler";
 ...
 */
export type ConnectionFilter<conParaT> = (connection: WSConnection<conParaT>, req: IncomingMessage) => null | StatusError;
